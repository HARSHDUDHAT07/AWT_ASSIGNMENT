...
const arr1 = [1, 2, 3];
const arr2 = [...arr1, 4, 5];
const obj1 = { name: "Harsh Dudhat", age: 19 };
const obj2 = { ...obj1, gender: "Male" };
const iterableArray = [80, 900, 500];
...
const Jyot = new Person("Harsh Dudhat", 19);
